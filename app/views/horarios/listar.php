...
<div class="card">
    ...
    <table>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align:center;padding:30px;color:#999">No hay horarios registrados para este medico</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
    ...
    <br>
    <a href="?url=medicos/listar" class="btn btn-secondary">Volver a medicos</a>
</div>
